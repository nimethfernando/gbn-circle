...
export default function Hero() {
    return (
        <section className="relative min-h-screen flex items-center justify-start pt-20 overflow-hidden text-left bg-gbn-navy">
            ...
            <div className="absolute inset-0 bg-[url('/vision-wide-Dafp-BMf.jpg')] bg-cover bg-center bg-no-repeat opacity-40"></div>
            ...
            <div className="container relative mx-auto px-6 md:px-12 z-10 max-w-7xl mt-12">
                <div className="max-w-3xl animate-fade-in-up">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                        <Link
                            href="/join"
                            className="w-full sm:w-auto bg-gradient-to-r from-gbn-gold to-gbn-gold-hover text-gbn-navy-dark text-xs tracking-[0.15em] font-bold px-8 py-4 rounded-sm transition-all hover:scale-105 flex items-center justify-center uppercase"
                        >
                            Join GBN Circle
                        </Link>
                        <Link
